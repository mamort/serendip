Serendip.InactiveFacetsView = Serendip.Class.extend({
    ...
    render : function(data) {
        ...
        this.bindEvents();
        this.showMoreFacetsView.render(data);
    },
    ...
    renderFacet : function(data, facet, facetArray) {
        ...
        if (len > (facet.minFacetsToDisplay * 2))
            len = facet.minFacetsToDisplay * 2;
    ...
    renderFacetsUI : function(facetsData, facets) {
        ...
        this.view.html(facetsData.join(""));
    },
    ...
    renderFacetUI : function(facet, facetFieldsData, facets, moreFacetsCount, moreFacetsFieldsData) {
        ...
        this.showMoreFacetsView.renderRow(facetsElement, facetValuesHtml, moreFacetsData);
